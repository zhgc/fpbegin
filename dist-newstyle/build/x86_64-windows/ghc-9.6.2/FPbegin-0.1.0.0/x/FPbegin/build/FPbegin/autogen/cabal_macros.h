...
/* package FPbegin-0.1.0.0 */
#ifndef VERSION_FPbegin
#define VERSION_FPbegin "0.1.0.0"
#endif /* VERSION_FPbegin */
#ifndef MIN_VERSION_FPbegin
#define MIN_VERSION_FPbegin(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_FPbegin */
...
#define CURRENT_COMPONENT_ID "FPbegin-0.1.0.0-inplace-FPbegin"
